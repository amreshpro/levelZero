...
console.log("- Tickets Price: ₹",movie1TicketPrice)
...
console.log("- Tickets Price: ₹",movie2TicketPrice)
...
console.log("Movie 3 : Idiots");
console.log("- Tickets Sold: ₹",movie3TicketsSold)
console.log("- Tickets Price: ₹",movie3TicketPrice)
